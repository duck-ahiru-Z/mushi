    ...
    <div className="flex items-center justify-between gap-2 mb-3 bg-slate-100 p-2 rounded-2xl flex-wrap">
      ...
      <div className="flex items-center gap-1.5">
        <button
          ...
          className="px-2.5 py-1.5 rounded-lg text-[10px] font-bold bg-sky-600 hover:bg-sky-700 text-white transition"
        >
          地下階を追加
        </button>
        ...
        <button
          ...
          className="px-2.5 py-1.5 rounded-lg text-[10px] font-bold bg-orange-600 hover:bg-orange-700 text-white transition"
        >
          地上階を追加
        </button>
